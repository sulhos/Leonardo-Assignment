...
def plot_wind_speed_distribution_and_power_curve(
    ...
    interpolated power curve (cut_in/rated/cut_out are used only for the
    plot's reference vlines, not for evaluating the curve itself)."""
    ...
    power = turbine_power_curve(speeds, rated_power_kw, power_curve_speed_power_fraction)
